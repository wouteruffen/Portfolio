...
const Index2 = () => {
  ...
  return (
    <>
      ...
      <div ref={scrollRef} className="min-h-screen snap-y snap-mandatory overflow-y-auto h-screen" style={{ background: DARK_BG }}>
        <NavbarV2 />
        <HeroV2 scrollContainerRef={scrollRef} />
        <AboutV2 />
        <ProjectsV2 />
        <ContactV2 />
        <footer className="py-6 px-6 md:px-16 lg:px-24 snap-start" style={{ background: DARK_BG }}>
